...
- Conclusão das funcionalidades principais do MVP.

## Pontos de melhoria

- Melhor organização inicial das integrações;
- Maior antecipação dos testes finais;
- Redução de retrabalho em algumas telas.

## Próximos passos

- Ajustes finais de UX/UI;
- Melhorias de acessibilidade;
- Possível expansão do sistema de relatórios e métricas.
...
- https://github.com/TeamStacked/PortalScrum/issues
